...
public class MobileMessageUtil {
    ...
    private static String accessKeyId = "LTAIyjd2uFo4We8s";
    //private static String accessKeySecret = "你的accessKeySecret";//你的accessKeySecret，参考本文档步骤2
    private static String accessKeySecret = "dkkuFhOUADteCrwPlWKzzUAcGf2f8P";
    //private static String setSignName = "你的短信签名名称";
    private static String setSignName = "刘浩";
    //private static String dayutemplateCode = "你的短信模板CODE";
    private static String dayutemplateCode = "SMS_140115371";
